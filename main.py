...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    layer_7A_out = tf.layers.conv2d(vgg_layer7_out, num_classes, 1, padding='SAME', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3), kernel_initializer=tf.random_normal_initializer(stddev=0.01))
	...
	# upsample
    layer_4A_in1 = tf.layers.conv2d_transpose(layer_7A_out, num_classes, 4, strides=(2, 2), padding='SAME', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3), kernel_initializer=tf.random_normal_initializer(stddev=0.01))

    # 1x1 conv of vgg layer4
    layer_4A_in2 = tf.layers.conv2d(vgg_layer4_out, num_classes, 1, padding='SAME', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3), kernel_initializer=tf.random_normal_initializer(stddev=0.01))
	...
	# upsample
    layer_3A_in1 = tf.layers.conv2d_transpose(layer_4A_out, num_classes, 4, strides=(2, 2), padding='SAME', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3), kernel_initializer=tf.random_normal_initializer(stddev=0.01))

	# 1x1 conv of vgg layer 3
    layer_3A_in2 = tf.layers.conv2d(vgg_layer3_out, num_classes, 1, padding='SAME', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3), kernel_initializer=tf.random_normal_initializer(stddev=0.01))

	# skip connection
    layer_3A_out = tf.add(layer_3A_in1, layer_3A_in2)

	# upsample
    nn_last_layer = tf.layers.conv2d_transpose(layer_3A_out, num_classes, 16, strides=(8, 8), padding='SAME', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3), kernel_initializer=tf.random_normal_initializer(stddev=0.01))
